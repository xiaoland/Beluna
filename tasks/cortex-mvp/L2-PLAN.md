...
## L2 File Index
1. `/Users/lanzhijiang/Development/Beluna/tasks/cortex-mvp/L2-PLAN-01-module-and-boundary-map.md`
- source/test/doc change map
- ownership and dependency direction

2. `/Users/lanzhijiang/Development/Beluna/tasks/cortex-mvp/L2-PLAN-02-domain-model-and-contracts.md`
- reaction input/output contracts
- distributed intent context model
- `IntentAttempt`/feedback correlation rules

3. `/Users/lanzhijiang/Development/Beluna/tasks/cortex-mvp/L2-PLAN-03-ports-and-ai-gateway-adapters.md`
- cognition organ interfaces
- real `ai_gateway` adapter design
- mock strategy for deterministic tests

4. `/Users/lanzhijiang/Development/Beluna/tasks/cortex-mvp/L2-PLAN-04-reactor-algorithms-and-state-machines.md`
- reactor loop algorithm
- clamp and one-repair pipeline
- backpressure and ingress assembly rules

5. `/Users/lanzhijiang/Development/Beluna/tasks/cortex-mvp/L2-PLAN-05-test-contract-and-doc-plan.md`
