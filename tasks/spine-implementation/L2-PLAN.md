...
## L2 File Index
1. `/Users/lanzhijiang/Development/Beluna/tasks/spine-implementation/L2-PLAN-01-module-and-file-map.md`
- source/test/doc change map
- dependency and ownership boundaries

2. `/Users/lanzhijiang/Development/Beluna/tasks/spine-implementation/L2-PLAN-02-core-interfaces-and-data-model.md`
- async spine interfaces
- route key, endpoint abstraction, capability catalog model
- affordance/capability canonical semantics

3. `/Users/lanzhijiang/Development/Beluna/tasks/spine-implementation/L2-PLAN-03-routing-catalog-and-dispatch-algorithms.md`
- registry and table-lookup algorithms
- catalog derivation and cortex bridge
- execution/report assembly algorithms

4. `/Users/lanzhijiang/Development/Beluna/tasks/spine-implementation/L2-PLAN-04-adapter-shells-unixsocket-websocket.md`
...
5. `/Users/lanzhijiang/Development/Beluna/tasks/spine-implementation/L2-PLAN-05-test-contract-and-doc-delta.md`
