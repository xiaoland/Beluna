...
## L2 File Index
1. `/Users/lanzhijiang/Development/Beluna/tasks/core-cortex-act-stem-refactor/L2-PLAN-01-module-and-file-map.md`
- source/test/doc delta map
- ownership and dependency boundaries

2. `/Users/lanzhijiang/Development/Beluna/tasks/core-cortex-act-stem-refactor/L2-PLAN-02-domain-model-and-interfaces.md`
...
3. `/Users/lanzhijiang/Development/Beluna/tasks/core-cortex-act-stem-refactor/L2-PLAN-03-stem-and-dispatch-algorithms.md`
- Stem loop algorithm
- control-sense interception rules
- serial per-act dispatch with `Continue | Break`

4. `/Users/lanzhijiang/Development/Beluna/tasks/core-cortex-act-stem-refactor/L2-PLAN-04-queue-shutdown-and-wire-protocol.md`
...
5. `/Users/lanzhijiang/Development/Beluna/tasks/core-cortex-act-stem-refactor/L2-PLAN-05-test-contract-and-doc-migration.md`
