...
## File Map
1. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-01-workstreams-and-sequence.md`
- ordered workstreams and dependency graph

2. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-02-file-change-map.md`
- exact file add/modify/delete map

3. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-03-core-pseudocode.md`
- cortex->non-cortex->spine cycle pseudocode

4. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-04-ledger-settlement-and-debit-pipeline.md`
- reservation lifecycle, settlement idempotency, attribution-matched external debit flow

5. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-05-test-execution-plan.md`
- contract-to-test mapping and execution commands

6. `/Users/lanzhijiang/Development/Beluna/tasks/refactor-mind-cortex-non-cortex/L3-PLAN-06-doc-and-result-plan.md`
