...
It is procedural, not authoritative, but it explicitly names the authoritative TDD files that must move with each slice so decisions do not get stranded in `tasks`.
...
- keep [BACKEND-REFACTOR-TARGET.md](/Users/lanzhijiang/Development/Beluna/tasks/moira-v1/BACKEND-REFACTOR-TARGET.md) and [FRONTEND-REFACTOR-TARGET.md](/Users/lanzhijiang/Development/Beluna/tasks/moira-v1/FRONTEND-REFACTOR-TARGET.md) aligned
