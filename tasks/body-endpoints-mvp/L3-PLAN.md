...
## File Map
1. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-01-workstreams-and-sequence.md`
- ordered workstreams, dependencies, and stop/go gates.

2. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-02-file-change-map.md`
- exact add/modify file list (no `core/src/*` edits).

3. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-03-runtime-and-endpoint-pseudocode.md`
- `runtime/src` lifecycle and `std-body` endpoint-host pseudocode.

4. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-04-socket-protocol-and-process-control.md`
- socket protocol handling, process supervision, reconnect behavior.

5. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-05-test-execution-plan.md`
- contract-to-test mapping and command plan.

6. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3-PLAN-06-doc-and-result-plan.md`
- documentation updates and final result output plan.

7. `/Users/lanzhijiang/Development/Beluna/tasks/body-endpoints-mvp/L3a-PLAN.md`
