...
use beluna::{
    non_cortex::{
        ...
        CostAdmissionPolicy, ExternalDebitObservation, InMemoryDebitSource, IntentAttempt,
        NonCortexFacade, NonCortexState, noop::SpinePortAdapter,
    },
...
fn facade_with_debit_source(debit_source: Arc<InMemoryDebitSource>) -> NonCortexFacade {
...
fn given_unmatched_attribution_when_applying_external_debit_then_observation_is_ignored() {
    ...
    let mut facade = facade_with_debit_source(Arc::clone(&debit_source));
