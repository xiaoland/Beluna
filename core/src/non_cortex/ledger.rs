...
use crate::non_cortex::{
    error::{NonCortexError, arithmetic_error, invalid_request, ledger_conflict},
    types::{CycleId, ExternalDebitObservation, LedgerEntryId, PolicyVersionTuple},
};
...
impl SurvivalLedger {
    ...
    pub fn expire_open_reservations(
        ...
        policy_versions: PolicyVersionTuple,
    ) -> Result<Vec<String>, NonCortexError> {
