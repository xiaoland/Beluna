...
7. Selected tick inspection is organized around a Core owner-lane timeline, narrative modes, and sectional subsystem views.
...
10. AI transport and chat-capability investigation are normally entered from the Core owner-lane timeline or expanded owner intervals.
