...
- Core emits a first-party native OTLP owner event surface that satisfies `docs/20-product-tdd/observability-contract.md`.
...
4. OTLP owner scope, `eventName`, span-key, body, or attribute changes must update the event surface table and minimum fixture set in `docs/30-unit-tdd/core/observability.md`.
