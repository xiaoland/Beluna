...
| `docs/descisions/001-observability-opentelemetry.md` | Promote | `-` | ADR family was later hard-deleted; operative conclusions remain in `docs/20-product-tdd/deployment-shaping-constraints.md`, `docs/30-unit-tdd/core/operations.md`, `docs/30-unit-tdd/apple-universal/design.md`, and `docs/40-deployment/observability.md` |
| `docs/descisions/002-config-schema-single-source-of-truth.md` | Promote | `-` | ADR family was later hard-deleted; operative conclusions remain in `docs/20-product-tdd/deployment-shaping-constraints.md`, `docs/30-unit-tdd/core/interfaces.md`, and `docs/40-deployment/environments.md` |
...
| `docs/features/continuity/PRD.md` | Rewrite | `docs/20-product-tdd/coordination-model.md; docs/30-unit-tdd/core/design.md` | Stable persistence/gate ownership retained |
...
| `docs/features/cortex/PRD.md` | Rewrite | `docs/10-prd/behavior/rules-and-invariants.md; docs/20-product-tdd/coordination-model.md; docs/30-unit-tdd/core/design.md` | Stable cognition-cycle truths retained in unit/system layers |
...
| `docs/features/spine/PRD.md` | Rewrite | `docs/20-product-tdd/unit-topology.md; docs/30-unit-tdd/core/design.md` | Stable dispatch boundary retained |
...
| `docs/features/stem/PRD.md` | Rewrite | `docs/20-product-tdd/coordination-model.md; docs/30-unit-tdd/core/design.md` | Stable runtime orchestration boundaries retained |
...
| `docs/modules/TOPOGRAPHY.md` | Rewrite | `docs/20-product-tdd/system-objective.md; docs/20-product-tdd/unit-topology.md; docs/20-product-tdd/coordination-model.md` | Top-level runtime topology retained in product TDD |
...
| `docs/modules/observability/README.md` | Rewrite | `docs/20-product-tdd/deployment-shaping-constraints.md; docs/40-deployment/observability.md` | Observability ownership/constraints retained |
...
| `docs/overview.md` | Rewrite | `docs/10-prd/behavior/claims.md; docs/10-prd/behavior/workflows.md; docs/20-product-tdd/system-objective.md` | Stable topology and product intent retained in layered form |
