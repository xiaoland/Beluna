...
- input helper direction is `structured input -> cognition-friendly output`
...
- Primary Input/Output IR carries fully-qualified neural signal ids only (no endpoint/sense/act split fields and no instance ids)
