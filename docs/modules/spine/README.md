...
3. neural-signal descriptor catalog snapshot owned by Spine registry
...
7. body endpoint descriptor/proprioception mutations are applied by direct runtime control calls into Stem (`StemControlPort`)
