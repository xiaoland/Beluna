...
- Non-cortex: Runtime substrate that defines what is possible, costly, and funded.
...
- AdmittedAction: Post-admission executable action accepted by non-cortex for spine.
